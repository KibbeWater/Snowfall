...
INL bool Hook::Init()
{
	...
	// Do hooks
	{
		DO_HOOK(MEM::PatternScan("GameAssembly.dll", "40 53 48 83 EC ? 80 3D ? ? ? ? ? 48 8B D9 75 ? 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 0D ? ? ? ? E8 ? ? ? ? C6 05 ? ? ? ? ? 80 7B ? ? 74 ? F3 0F 10 15 ? ? ? ? 45 33 C9 C6 43 ? ? 48 8B CB 48 8B 15 ? ? ? ? E8 ? ? ? ? 48 8B 05"), 
			PunchPlayers, Punch);
		...
		DO_HOOK(MEM::PatternScan("GameAssembly.dll", "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 60 80 3D ? ? ? ? ? 49 8B F0 48 8B FA 48 8B D9 75 7F"),
		...
		DO_HOOK(MEM::PatternScan("GameAssembly.dll", "48 89 5C 24 ? 48 89 74 24 ? 55 48 8D 6C 24 ? 48 81 EC ? ? ? ? 80 3D ? ? ? ? ? 48 8B F2"),
			ItemGun, TryUse);
		DO_HOOK(MEM::PatternScan("GameAssembly.dll", "48 89 5C 24 ? 56 48 83 EC 50 80 3D ? ? ? ? ? 48 8B F2 48 8B D9 75 37 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 0D ? ? ? ? E8 ? ? ? ? C6 05 ? ? ? ? ? 80 7B 28 00"),
			ItemMelee, TryUse);
		DO_HOOK(MEM::PatternScan("GameAssembly.dll", "40 55 56 57 41 54 41 56 48 8D 6C 24"),
